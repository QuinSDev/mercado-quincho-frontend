          ...
          <div className="space-y-12">
            <div className="border-b border-gray-900/10 pb-12">
              ...
              <div className="mt-10 col-span-full">
                ...
                <div className="mt-6 formQuincho">
                  <input type="text"
                    name="location"
                    id="location"
                    value={location} onChange={onInputChange}
                    placeholder=" " />
                ...
                <div className="mt-6 formQuincho">
                  <input type="number"
                    name="price"
                    id="price"
                    value={price} onChange={onInputChange}
                    placeholder=" " />
                  <label htmlFor="price">Precio por Noche</label>
                </div>

                <label htmlFor="typeQuincho" className="mt-6 ml-2 block text-sm font-medium leading-6 text-gray-900">Tipo de Quincho</label>
                <div className="mt-2 formQuincho">
                  <select type="text"
                    name="typeQuincho"
                    id="typeQuincho"
                    value={typeQuincho} onChange={onInputChange}
                    placeholder=" ">
                    <option value="" disabled><h2>Seleccionar</h2></option>
              ...
              <div className="mt-10 border-t border-gray-900/10 pb-12">
                <h2 className="text-center mt-6 text-xl font-bold leading-7 text-gray-900">Servicios</h2>
                <p className="text-center mt-1 text-lg leading-6 text-[#35C5DF]">Completa los servicios de tu Quincho</p>
                ...
                <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                  ...
                  <div className="sm:col-span-3 formQuincho">
                    <input type="number"
                      name="numGuest"
                      id="numGuest"
                      value={numGuest} onChange={onInputChange}
                      placeholder=" " />
                  ...
                  <div className="sm:col-span-3 formQuincho">
                    <input type="number"
                      name="numBedroom"
                      id="numBedroom"
                      value={numBedroom} onChange={onInputChange}
                      placeholder=" " />
                  ...
                  <div className="sm:col-span-3 formQuincho">
                    <input type="number"
                      name="numBed"
                      id="numBed"
                      value={numBed} onChange={onInputChange}
                      placeholder=" " />
              ...
              <div className="mt-0 border-t border-gray-900/10 pb-12">
                <h2 className="text-center mt-6 text-xl font-bold leading-7 text-gray-900">Fotos</h2>
                <p className="text-center mt-1 text-lg leading-6 text-[#35C5DF]">Sube las fotos de tu Quincho</p>
