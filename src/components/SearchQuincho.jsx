...
export const SearchQuincho = ({ types, filterType }) => {
  const typeIcons = {
    "Todos": <img className="h-10 w-10" src={home} alt="Logo de quinchos" />,
    "Chalet": <img className="h-10 w-10" src={chalet} alt="Logo de chalets" />,
    "Quinta": <img className="h-10 w-10" src={quinta} alt="Logo de quintas" />,
    "Cabaña": <img className="h-10 w-10" src={cabaña} alt="Logo de cabañas" />,
  };
    ...
    <>
      ...
      >
        <ul className="shadow-lg m-4 menu bg-base-200 lg:menu-horizontal rounded-box">
          {types.map((type) => (
            <li
              className="font-semibold text-lg hover:bg-[#35C5DF] rounded-md"
              key={type} // Mueve la prop key aquí
            >
