            ...
            {quinchos.map((quincho) => (
              <div key={quincho.id} className="group relative">
                ...
                <div className="mt-4 flex justify-between">
                  <div>
                    <p className="mt-1 text-l font-semibold text-gray-900">
                      {quincho.nameQuincho}
                    </p>
                    ...
                    <button className="btn bg-[#35C5DF] text-white hover:bg-black hover:text-white font-semibold px-3 py-1.5 rounded-md transition duration-300 mt-2">
                      Ver Quincho
                    </button>
                  </div>
                </div>
